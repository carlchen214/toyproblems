...
var mergeSort = function(array) {
  ...
  // return arr.concat(i < leftLength ? left.slice(i) : right.slice(j));
...
// var sorted = mergeSort([7, 4]);
// var sort = mergeSort([1]);
// console.log(sort);
// var sorted = mergeSort([4, 7, 4, 3, 9, 1, 2]);
var sorted = mergeSort([7, 5, 2, 3, 4, 4, 3]);
console.log(sorted);